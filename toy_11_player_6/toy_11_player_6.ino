...
void setup() {
  ...
  // OSC Messages
  OSCMessage error_msg("/player6/error/");
...
void loop() {
 ...
 tcaselect(tof1_TCA_ADDR);
  ...
  OSCMessage mpu_msg("/player6/mpu/");
  mpu_msg.add(Ax);
  mpu_msg.add(Ay);
  mpu_msg.add(Az);
  ...
  OSCMessage apds_msg("/player6/apds/");
  apds_msg.add(r);
  apds_msg.add(g);
  apds_msg.add(b);
  apds_msg.add(c);
  ...
  OSCMessage tof1_msg("/player6/tof1/");
  ...
  OSCMessage tof2_msg("/player6/tof2/");
