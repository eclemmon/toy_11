...
void setup() {
  ...
  // OSC Messages
  OSCMessage error_msg("/player5/error/");
...
void loop() {
  ...
  OSCMessage mpu_msg("/player5/mpu/");
  mpu_msg.add(Ax);
  mpu_msg.add(Ay);
  mpu_msg.add(Az);
  ...
  OSCMessage apds_msg("/player5/apds/");
  apds_msg.add(r);
  apds_msg.add(g);
  apds_msg.add(b);
  apds_msg.add(c);
  ...
  OSCMessage tof1_msg("/player5/tof1/");
  ...
  OSCMessage tof2_msg("/player5/tof2/");
